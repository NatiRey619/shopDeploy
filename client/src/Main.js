...
function Main() {
  ...
  /// props example
  const Fields = ({ FieldName, type, placeholder }) => {
    console.log({ FieldName, type, placeholder });
    return (
      <div className="fieldsContainer">
        <label className="fieldLabel">{FieldName}</label>
        <input type={type} className="fieldInput" placeholder={placeholder} />
      </div>
    );
  };
  ...
  return (
    <BrowserRouter>
      <MyContext.Provider value={{ cart, setCart, data, filterProducts }}>
        <header>
          <Header />
        </header>
        <Routes>
